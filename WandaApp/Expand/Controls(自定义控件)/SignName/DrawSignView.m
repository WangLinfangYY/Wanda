...
#define Scale [[UIScreen mainScreen]bounds].size.width/1000
...
- (void)createView
{
    ...
    self.frame = CGRectMake(0, 0, 1000*Scale, 500*Scale);
    ...
    contentLbl.frame = CGRectMake(0, 50*Scale, 1000*Scale, 50*Scale);
...
//    [cancelBtn setTitleColor:[UIColor blueColor] forState:UIControlStateNormal];
    ...
    for (UIButton *btn in btnRArr) {
        btn.frame = CGRectMake(910*Scale, btn_y+ i * (btn_h+btn_mid), btn_w, btn_h);
        i++;
    }
    ...
    sliderLbl.frame = CGRectMake(100, 400*Scale, 100, 20);
...
//    [self addSubview:penBoldSlider];
    ...
    self.drawView=[[MyView alloc]initWithFrame:CGRectMake(100, 100, 800*Scale, 800/3.0*Scale)];
